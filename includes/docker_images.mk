${build_logger}: ${docker_buildpath}
	...
	docker build --rm -t "mother/logger:latest" ${docker_buildpath}/logger
...
${build_puppetmaster}: ${docker_buildpath}
	...
	docker build --rm -t "mother/puppetmaster:latest" ${docker_buildpath}/puppetmaster
...
# 	docker build --rm -t "mother/puppetdb:latest" ${docker_buildpath}/puppetdb
...
${build_foreman}: ${docker_buildpath}
	...
	docker build --rm -t "mother/foreman:latest" ${docker_buildpath}/foreman
